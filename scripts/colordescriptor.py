...
class ColorDescriptor:
    ...
    def describe(self, image):
        # convert the image the HSV color space and initialize the features used to quantify the image 
        ...
        for (startX, endX, startY, endY) in segments:
            # construct the mask for each conver of the image, subtracting the elliptical center from it 
